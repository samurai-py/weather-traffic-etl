...
if __name__ == "__main__":
    ...
    run_pos_validate(file_path='../../data/weather_cleaned_data.csv', cols_json='validation_assets/cols/weather_cols.json', cities_json='validation_assets/cities.json')
    run_pos_validate(file_path='../../data/directions_cleaned_data.csv', cols_json='validation_assets/cols/directions_cols.json', cities_json='validation_assets/cities.json', name_normalized_cols=['origin_name_normalized', 'destination_name_normalized'])
